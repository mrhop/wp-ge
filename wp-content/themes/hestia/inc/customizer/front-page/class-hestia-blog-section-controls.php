...
class Hestia_Blog_Section_Controls extends Hestia_Front_Page_Section_Controls_Abstract
{
    ...
    {
        $this->add_blog_categories_control();
     ...
     */
    private function add_blog_categories_control()
    {
        $this->add_control(
            new Hestia_Customizer_Control(
                ...
                array(
                    'label' => esc_html__('Category of Items', 'hestia'),
                    'section' => 'hestia_blog',
                    'priority' => 13

                ),
                'Hestia_East_Categories',
                array(
                    'selector' => '.hestia-blog-content',
                    'settings' => 'hestia_blog_categories',
                    'render_callback' => array($this, 'blog_content_callback'),
                )
            )
