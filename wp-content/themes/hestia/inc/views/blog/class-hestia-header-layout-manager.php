...
//			$header_content_output .= single_post_title( '', false );
                $header_content_output .= $top_title;
                $header_content_output .= '</h1>';
            }
        ...
        $header_content_output = '';
        if (!empty($top_title)) {
            $header_content_output .= '<h1 class="' . esc_attr($title_class) . ' ' . esc_attr($entry_class) . '">' . $top_title . '</h1>';
        }
        $sub_title = get_field('sub_title');
        if ($sub_title) {
            $header_content_output .= '<p class="description">' . $sub_title . '</p>';
        }
        return $header_content_output;
    }
